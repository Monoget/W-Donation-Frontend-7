! function(e, t) {
    ...
    var h = function(n) {
        ...
        for (e in h = re.support = {}, o = re.isXML = function(e) {
                ...
                if ((e.ownerDocument || e) !== C && k(e), t = t.replace(U, "='$1']"), h.matchesSelector && x && !j[t + " "] && (!a || !a.test(t)) && (!g || !g.test(t))) try {
                    var n = d.call(e, t);
                        ...
                        return 1 === m && 0 === g ? function(e) {
                            ...
                            if (d) {
                                ...
                                if (l = [b ? d.firstChild : d.lastChild], b && f) {
                                    for (h = (a = (i = (o = (r = (s = d)[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === E && i[1]) && i[2], s = a && d.childNodes[a]; s = ++a && s && s[c] || (h = a = 0) || l.pop();)
                                        if (1 === s.nodeType && ++h && s === e) {
                                            o[p] = [E, a, h];
                                            break
                                        }
                                } else if (f && (h = a = (i = (o = (r = (s = e)[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] || [])[0] === E && i[1]), !1 === h)
                                    for (;
                                        (s = ++a && s && s[c] || (h = a = 0) || l.pop()) && ((y ? s.nodeName.toLowerCase() !== u : 1 !== s.nodeType) || !++h || (f && ((o = (r = s[T] || (s[T] = {}))[s.uniqueID] || (r[s.uniqueID] = {}))[p] = [E, h]), s !== e)););
                    ...
                    for (; e = e[l];)
                        if (1 === e.nodeType || u)
                            if (o = (r = e[T] || (e[T] = {}))[e.uniqueID] || (r[e.uniqueID] = {}), c && c === e.nodeName.toLowerCase()) e = e[l] || e;
                                ...
                                if ((i = o[d]) && i[0] === E && i[1] === f) return s[2] = i[2];
                ...
                if (t = _.relative[e[a].type]) d = [be(ye(d), t)];
                    ...
                    if ((t = _.filter[e[a].type].apply(null, e[a].matches))[T]) {
                        ...
                        return we(1 < a && ye(d), 1 < a && ve(e.slice(0, a - 1).concat({
                            value: " " === e[a - 2].type ? "*" : ""
                        })).replace(R, "$1"), t, a < n && ke(e.slice(a, n)), n < i && ke(e = e.slice(n)), n < i && ve(e))
                    }
                    d.push(t)
                } return ye(d)
        }
        return ge.prototype = _.filters = _.pseudos, _.setFilters = new ge, p = re.tokenize = function(e, t) {
            ...
            for (s = e, a = [], l = _.preFilter; s;) {
                for (r in n && !(i = z.exec(s)) || (i && (s = s.slice(i[0].length) || s), a.push(o = [])), n = !1, (i = F.exec(s)) && (n = i.shift(), o.push({
                        value: n,
                        type: i[0].replace(R, " ")
                    }), s = s.slice(n.length)), _.filter) !(i = Y[r].exec(s)) || l[r] && !(i = l[r](i)) || (n = i.shift(), o.push({
                    value: n,
                    type: r,
                    matches: i
                }), s = s.slice(n.length));
            ...
            if (!s) {
                ...
                (s = j(e, (g = r, v = o, b = 0 < v.length, y = 0 < g.length, i = function(e, t, n, i, o) {
                    var r, s, a, l = 0,
                        c = "0",
                        d = e && [],
                        u = [],
            ...
            if (n = n || [], 1 === d.length) {
                ...
                for (o = Y.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !_.relative[a = s.type]);)
    ...
    T.filter = function(e, t, n) {
        ...
        is: function(e) {
            return !!A(this, "string" == typeof e && E.test(e) ? T(e) : e || [], !1).length
        }
    });
    var D, N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ...
    T.Callbacks = function(i) {
        var e, n;
        i = "string" == typeof i ? (e = i, n = {}, T.each(e.match(P) || [], function(e, t) {
            n[t] = !0
        }), n) : T.extend({}, i);
        var o, t, r, s, a = [],
            l = [],
                ...
                s = {
                    ...
                    then: function(t, n, i) {
                                ...
                                var n = this,
                                    ...
                                    e = function() {
                                        ...
                                        if (!(o < l)) {
                                            ...
                                            t = e && ("object" == typeof e || "function" == typeof e) && e.then, b(t) ? a ? t.call(e, c(l, r, L, a), c(l, r, H, a)) : (l++, t.call(e, c(l, r, L, a), c(l, r, H, a), c(l, r, L, r.notifyWith))) : (s !== L && (n = void 0, i = [e]), (a || r.resolveWith)(n, i))
                                        }
                                    },
                                    t = a ? e : function() {
                                        try {
                        ...
                        return T.Deferred(function(e) {
                            r[0][3].add(c(0, e, b(i) ? i : L, e.notifyWith)), r[1][3].add(c(0, e, b(t) ? t : L)), r[2][3].add(c(0, e, b(n) ? n : H))
                        }).promise()
                    },
                    promise: function(e) {
    ...
    function R() {
        x.removeEventListener("DOMContentLoaded", R), C.removeEventListener("load", R), T.ready()
    }
    ...
    }), T.ready.then = M.then, "complete" === x.readyState || "loading" !== x.readyState && !x.documentElement.doScroll ? C.setTimeout(T.ready) : (x.addEventListener("DOMContentLoaded", R), C.addEventListener("load", R));
    ...
    T.event = {
        ...
        add: function(t, e, n, i, o) {
            var r, s, a, l, c, d, u, f, h, p, m, g = V.get(t);
            if (g)
                for (n.handler && (n = (r = n).handler, o = r.selector), o && T.find.matchesSelector(be, o), n.guid || (n.guid = T.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function(e) {
                    ...
                    }), c = (e = (e || "").match(P) || [""]).length; c--;) h = m = (a = we.exec(e[c]) || [])[1], p = (a[2] || "").split(".").sort(), h && (u = T.event.special[h] || {}, h = (o ? u.delegateType : u.bindType) || h, u = T.event.special[h] || {}, d = T.extend({
                    type: h,
                    origType: m,
                    data: i,
                    handler: n,
        ...
        remove: function(e, t, n, i, o) {
            var r, s, a, l, c, d, u, f, h, p, m, g = V.hasData(e) && V.get(e);
            if (g && (l = g.events)) {
    ...
    function qe(n, i, o, r) {
        ...
        if (u && (t = (e = ve(i, n[0].ownerDocument, !1, n, r)).firstChild, 1 === e.childNodes.length && (e = t), t || r)) {
            ...
            if (a)
                for (c = s[s.length - 1].ownerDocument, T.map(s, Ie), d = 0; d < a; d++) l = s[d], de.test(l.type || "") && !V.access(l, "globalEval") && T.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && T._evalUrl(l.src) : _(l.textContent.replace(Ae, ""), c, l))
        }
        return n
    }
    ...
    T.extend({
        ...
        html: function(e) {
            return z(this, function(e) {
                ...
                if ("string" == typeof e && !je.test(e) && !ue[(ce.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = T.htmlPrefilter(e);
                    try {
    ...
    function Be(e, t, n) {
        ...
        return (n = n || He(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || T.contains(e.ownerDocument, e) || (s = T.style(e, t)), !v.pixelBoxStyles() && Le.test(s) && We.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    function Xe(e, t, n) {
        ...
        return s = s && (v.boxSizingReliable() || o === e.style[t]), ("auto" === o || !parseFloat(o) && "inline" === T.css(e, "display", !1, i)) && (o = e["offset" + t[0].toUpperCase() + t.slice(1)], s = !0), (o = parseFloat(o) || 0) + Ve(e, t, n || (r ? "border" : "content"), s, i, o) + "px"
    }
    ...
    T.extend({
        ...
        css: function(e, t, n, i) {
            var o, r, s, a = K(t);
            return ze.test(t) || (t = Ye(a)), (s = T.cssHooks[t] || T.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = Be(e, t, i)), "normal" === o && t in Ue && (o = Ue[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
    }), T.each(["height", "width"], function(e, a) {
        T.cssHooks[a] = {
            get: function(e, t, n) {
                if (t) return !Re.test(T.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Xe(e, a, n) : oe(e, Fe, function() {
                    return Xe(e, a, n)
                })
            },
            set: function(e, t, n) {
                var i, o = He(e),
                    ...
                    s = n && Ve(e, a, n, r, o);
                return r && v.scrollboxSize() === o.position && (s -= Math.ceil(e["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(o[a]) - Ve(e, a, "border", !1, o) - .5)), s && (i = te.exec(t)) && "px" !== (i[3] || "px") && (e.style[a] = t, t = T.css(e, a)), $e(0, t, s)
            }
        }
    ...
    function lt(r, e, t) {
        ...
        for (function(e, t) {
            ...
            if (n = lt.prefilters[i].call(c, r, d, c.opts)) return b(n.stop) && (T._queueHooks(c.elem, c.opts.queue).stop = n.stop.on(bind(n))), n;
    ...
    T.Animation = T.extend(lt, {
        ...
        tweener: function(e, t) {
            for (var n, i = 0, o = (e = b(e) ? (t = e, ["*"]) : e.match(P)).length; i < o; i++) n = e[i], lt.tweeners[n] = lt.tweeners[n] || [], lt.tweeners[n].unshift(t)
        },
        prefilters: [function(e, t, n) {
            ...
            for (i in n.queue || (null == (s = T._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function() {
                ...
                for (i in u && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = g && g.display) && (c = V.get(e, "display")), "none" === (d = T.css(e, "display")) && (c ? d = c : (ae([e], !0), c = e.style.display || c, d = T.css(e, "display"), ae([e]))), ("inline" === d || "inline-block" === d && null != c) && "none" === T.css(e, "float") && (l || (f.done(function() {
                        p.display = c
                    ...
                    for (i in m || ae([e]), V.remove(e, "fxshow"), h) T.style(e, i, h[i])
    ...
    T.extend(T.event, {
        trigger: function(e, t, n, i) {
            ...
            if (r = u = s = n = n || x, 3 !== n.nodeType && 8 !== n.nodeType && !vt.test(h + T.event.triggered) && (-1 < h.indexOf(".") && (h = (p = h.split(".")).shift(), p.sort()), l = h.indexOf(":") < 0 && "on" + h, (e = e[T.expando] ? e : new T.Event(h, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = p.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : T.makeArray(t, [e]), d = T.event.special[h] || {}, i || !d.trigger || !1 !== d.trigger.apply(n, t))) {
                ...
                for (o = 0;
                    (r = f[o++]) && !e.isPropagationStopped();) u = r, e.type = 1 < o ? a : d.bindType || h, (c = (V.get(r, "events") || {})[e.type] && V.get(r, "handle")) && c.apply(r, t), (c = l && r[l]) && c.apply && Y(r) && (e.result = c.apply(r, t), !1 === e.result && e.preventDefault());
                return e.type = h, i || e.isDefaultPrevented() || d._default && !1 !== d._default.apply(f.pop(), t) || !Y(n) || l && b(n[h]) && !y(n) && ((s = n[l]) && (n[l] = null), T.event.triggered = h, e.isPropagationStopped() && u.addEventListener(h, bt), n[h](), e.isPropagationStopped() && u.removeEventListener(h, bt), T.event.triggered = void 0, s && (n[l] = s)), e.result
            }
        },
    ...
    Lt.href = yt.href, T.extend({
        ...
        ajax: function(e, t) {
            ...
            if (y.promise(k), g.url = ((e || g.url || yt.href) + "").replace(It, yt.protocol + "//"), g.type = t.method || t.type || g.method || g.type, g.dataTypes = (g.dataType || "*").toLowerCase().match(P) || [""], null == g.crossDomain) {
                i = x.createElement("a");
                try {
                    i.href = g.url, i.href = i.href, g.crossDomain = Lt.protocol + "//" + Lt.host != i.protocol + "//" + i.host
                } catch (e) {
                    g.crossDomain = !0
                }
            }
            if (g.data && g.processData && "string" != typeof g.data && (g.data = T.param(g.data, g.traditional)), Wt(Ot, g, t, k), p) return k;
            for (o in (m = T.event && g.global) && 0 == T.active++ && T.event.trigger("ajaxStart"), g.type = g.type.toUpperCase(), g.hasContent = !Nt.test(g.type), u = g.url.replace(St, ""), g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(jt, "+")) : (r = g.url.slice(u.length), g.data && (g.processData || "string" == typeof g.data) && (u += (wt.test(u) ? "&" : "?") + g.data, delete g.data), !1 === g.cache && (u = u.replace(At, "$1"), r = (wt.test(u) ? "&" : "?") + "_=" + _t++ + r), g.url = u + r), g.ifModified && (T.lastModified[u] && k.setRequestHeader("If-Modified-Since", T.lastModified[u]), T.etag[u] && k.setRequestHeader("If-None-Match", T.etag[u])), (g.data && g.hasContent && !1 !== g.contentType || t.contentType) && k.setRequestHeader("Content-Type", g.contentType), k.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Pt + "; q=0.01" : "") : g.accepts["*"]), g.headers) k.setRequestHeader(o, g.headers[o]);
    ...
    v.cors = !!Rt && "withCredentials" in Rt, v.ajax = Rt = !!Rt, T.ajaxTransport(function(o) {
        var r, s;
    ...
    T.ajaxSetup({
    ...
    }), v.createHTMLDocument = ((zt = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === zt.childNodes.length), T.parseHTML = function(e, t, n) {
        ...
        T.cssHooks[n] = Me(v.pixelPosition, function(e, t) {
            if (t) return t = Be(e, n), Le.test(t) ? T(e).position()[n] + "px" : t
        })
    }), T.each({
        Height: "height",
        Width: "width"
    ...
    }, T.isArray = Array.isArray, T.parseJSON = JSON.parse, T.nodeName = j, T.isFunction = b, T.isWindow = y, T.camelCase = K, T.type = w, T.now = Date.now, T.isNumeric = function(e) {
        var t = T.type(e);
...
function(e, t) {
    ...
    function i(e, t, n, i) {
        return H(t["offset" + e], t["scroll" + e], n["client" + e], n["offset" + e], n["scroll" + e], R() ? n["offset" + e] + i["margin" + ("Height" === e ? "Top" : "Left")] + i["margin" + ("Height" === e ? "Bottom" : "Right")] : 0)
    }
    ...
    function f(e, t, n, i) {
        var o, r, s, a, l, c, d, u = {
            ...
            f = k(e, t);
        if ("viewport" === i) r = (o = f).ownerDocument.documentElement, s = j(o, r), a = H(r.clientWidth, window.innerWidth || 0), l = H(r.clientHeight, window.innerHeight || 0), c = C(r), d = C(r, "left"), u = T({
    ...
    for (var P = Math.min, L = Math.floor, H = Math.max, m = "undefined" != typeof window && "undefined" != typeof document, g = ["Edge", "Trident", "Firefox"], v = 0, W = 0; W < g.length; W += 1)
        ...
        modifiers: {
                        ...
                        s = {
                            ...
                            secondary: function(e) {
                                var t = "right" === e ? "left" : "top",
                                    n = r[t];
                                return r[e] > o[e] && !i.escapeWithReference && (n = P(r[t], o[e] - ("right" === e ? r.width : r.height))), F({}, t, n)
                            }
                        };
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    return y = H(P(s[c] - p, y), 0), e.arrowElement = i, e.offsets.arrow = (F(n = {}, u, Math.round(y)), F(n, f, ""), n), e
                },
                element: "[x-arrow]"
            },
            flip: {
...
function(e, t) {
    ...
    u = u && u.hasOwnProperty("default") ? u.default : u, p = p && p.hasOwnProperty("default") ? p.default : p;
    var t = "transitionend";
    var m = {
    ...
    p(document).on(I.CLICK_DATA_API, "[data-slide], [data-slide-to]", L._dataApiClickHandler), p(window).on(I.LOAD_DATA_API, function() {
        for (var e = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), t = 0, n = e.length; t < n; t++) {
            var i = p(e[t]);
            L._jQueryInterface.call(i, i.data())
        }
    }), p.fn[C] = L._jQueryInterface, p.fn[C].Constructor = L, p.fn[C].noConflict = function() {
        return p.fn[C] = j, L._jQueryInterface
    };
    var H = "",
        W = "",
        B = "." + W,
        ...
        V = function() {
            function a(t, e) {}
            var e = a.prototype;
            return e.toggle = function() {}, e.show = function() {}, e.hide = function() {
                var e = this;
                if (!this._isTransitioning && p(this._element).hasClass(U)) {}
            }, e.setTransitioning = function(e) {}, e.dispose = function() {
            ...
            }, e._getConfig = function(e) {}, e._getDimension = function() {
                return p(this._element).hasClass("width") ? "width" : "height"
            }, e._getParent = function() {}, e._addAriaAndCollapsedClass = function(e, t) {
    ...
    p(document).on(F.CLICK_DATA_API, $, function(e) {
    ...
    }), p.fn[H] = V._jQueryInterface, p.fn[H].Constructor = V, p.fn[H].noConflict = function() {
        return p.fn[H] = M, V._jQueryInterface
    };
    var X = " ",
        G = "",
        J = "." + G,
        ...
        de = function() {
            ...
            }, c._clearMenus = function(e) {}, c._getParentFromElement = function(e) {}, c._dataApiKeydownHandler = function(e) {}, s(c, null, [{
                key: "VERSION",
                get: function() {
                    return "4.2.1"
                }
    ...
    p(document).on(ne.KEYDOWN_DATA_API, se, de._dataApiKeydownHandler).on(ne.KEYDOWN_DATA_API, ae, de._dataApiKeydownHandler).on(ne.CLICK_DATA_API + " " + ne.KEYUP_DATA_API, de._clearMenus).on(ne.CLICK_DATA_API, se, function(e) {}).on(ne.CLICK_DATA_API, ".dropdown form", function(e) {}), p.fn[X] = de._jQueryInterface, p.fn[X].Constructor = de, p.fn[X].noConflict = function() {};
    var ue = "modal",
        fe = "bs.modal",
        he = "." + fe,
        pe = p.fn[ue],
            ...
            return e.enable = function() {
                ...
                if (this._isEnabled)
                    if (e) {
                        ...
                        if (p(this.getTipElement()).hasClass(Le)) return void this._leave(null, this);
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    o.setAttribute("id", r), this.element.setAttribute("aria-describedby", r), this.setContent(), this.config.animation && p(o).addClass(Pe);
                    ...
                    }), p(o).addClass(Le), "ontouchstart" in document.documentElement && p(document.body).children().on("mouseover", null, p.noop);
                    var c = function() {
                        t.config.animation && t._fixTransition();
                        var e = t._hoverState;
                        t._hoverState = null, p(t.element).trigger(t.constructor.Event.SHOWN), "out" === e && t._leave(null, t)
                    };
                    if (p(this.tip).hasClass(Pe)) {
                ...
                var t = this,
                    ...
                    o = function() {
                        t._hoverState !== Oe && n.parentNode && n.parentNode.removeChild(n), t._cleanTipClass(), t.element.removeAttribute("aria-describedby"), p(t.element).trigger(t.constructor.Event.HIDDEN), null !== t._popper && t._popper.destroy(), e && e()
                    };
                if (p(this.element).trigger(i), !i.isDefaultPrevented()) {
                    if (p(n).removeClass(Le), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger.click = !1, this._activeTrigger[We] = !1, this._activeTrigger[He] = !1, p(this.tip).hasClass(Pe)) {
                ...
                p(this.getTipElement()).addClass(Se + "-" + e)
            }, e.getTipElement = function() {
                return this.tip = this.tip || p(this.config.template)[0], this.tip
            }, e.setContent = function() {
                var e = this.getTipElement();
                this.setElementContent(p(e.querySelectorAll(".tooltip-inner")), this.getTitle()), p(e).removeClass(Pe + " " + Le)
                ...
                var n = this.constructor.DATA_KEY;
                (t = t || p(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), p(e.currentTarget).data(n, t)), e && (t._activeTrigger["focusout" === e.type ? We : He] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = "out", t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function() {
                ...
                return "number" == typeof(e = l({}, this.constructor.Default, p(this.element).data(), "object" == typeof e && e ? e : {})).delay && (e.delay = {
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), m.typeCheckConfig(xe, e, this.constructor.DefaultType), e
                ...
                null === e.getAttribute("x-placement") && (p(e).removeClass(Pe), this.config.animation = !1, this.hide(), this.show(), this.config.animation = t)
            }, i._jQueryInterface = function(n) {
                return this.each(function() {
                    var e = p(this).data(Te),
                        t = "object" == typeof n && n;
                    if ((e || !/dispose|hide/.test(n)) && (e || (e = new i(this, t), p(this).data(Te, e)), "string" == typeof n)) {
                        if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                        e[n]()
                    }
                })
    ...
    p.fn[xe] = Be._jQueryInterface, p.fn[xe].Constructor = Be, p.fn[xe].noConflict = function() {
        return p.fn[xe] = je, Be._jQueryInterface
    };
    var Me = "popover",
        Re = "bs.popover",
        ze = "." + Re,
        ...
        Ve = function(e) {
            ...
            return o.isWithContent = function() {
                ...
                p(this.getTipElement()).addClass(Ue + "-" + e)
                ...
                return this.each(function() {
                    var e = p(this).data(Re),
                        t = "object" == typeof n ? n : null;
                    if ((e || !/dispose|hide/.test(n)) && (e || (e = new i(this, t), p(this).data(Re, e)), "string" == typeof n)) {
                        if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                        e[n]()
                    }
                })
    ...
    p.fn[Me] = Ve._jQueryInterface, p.fn[Me].Constructor = Ve, p.fn[Me].noConflict = function() {
        return p.fn[Me] = Fe, Ve._jQueryInterface
    };
    var Xe = "scrollspy",
        Ge = "bs.scrollspy",
        Je = "." + Ge,
        ...
        lt = function() {
            function n(e, t) {
                var n = this;
                this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(t), this._selector = this._config.target + " " + rt + "," + this._config.target + " " + st + "," + this._config.target + " .dropdown-item", this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on(nt.SCROLL, function(e) {
                    return n._process(e)
            ...
            return e.refresh = function() {
                ...
                p.removeData(this._element, Ge), p(this._scrollElement).off(Je), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, e._getConfig = function(e) {
                if ("string" != typeof(e = l({}, et, "object" == typeof e && e ? e : {})).target) {
                    var t = p(e.target).attr("id");
                    t || (t = m.getUID(Xe), p(e.target).attr("id", t)), e.target = "#" + t
                }
                return m.typeCheckConfig(Xe, e, tt), e
                ...
                n.hasClass("dropdown-item") ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(it), n.addClass(it)) : (n.addClass(it), n.parents(ot).prev(rt + ", " + st).addClass(it), n.parents(ot).prev(".nav-item").children(rt).addClass(it)), p(this._scrollElement).trigger(nt.ACTIVATE, {
                    relatedTarget: t
                })
            }, e._clear = function() {
                [].slice.call(document.querySelectorAll(this._selector)).filter(function(e) {
                    return e.classList.contains(it)
                }).forEach(function(e) {
                    return e.classList.remove(it)
                })
            }, n._jQueryInterface = function(t) {
                return this.each(function() {
                    var e = p(this).data(Ge);
                    if (e || (e = new n(this, "object" == typeof t && t), p(this).data(Ge, e)), "string" == typeof t) {
                        if (void 0 === e[t]) throw new TypeError('No method named "' + t + '"');
                        e[t]()
                    }
                })
    ...
    p(window).on(nt.LOAD_DATA_API, function() {
        for (var e = [].slice.call(document.querySelectorAll('[data-spy="scroll"]')), t = e.length; t--;) {
            var n = p(e[t]);
            lt._jQueryInterface.call(n, n.data())
        }
    }), p.fn[Xe] = lt._jQueryInterface, p.fn[Xe].Constructor = lt, p.fn[Xe].noConflict = function() {
        return p.fn[Xe] = Ze, lt._jQueryInterface
    };
    var ct = "bs.tab",
        ...
        gt = function() {
            ...
            return e.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(ht) || p(this._element).hasClass("disabled"))) {
                    ...
                    if (t) {
                        var r = "UL" === t.nodeName || "OL" === t.nodeName ? mt : pt;
                        i = (i = p.makeArray(p(t).find(r)))[i.length - 1]
                    }
                    var s = p.Event(ft.HIDE, {
                            relatedTarget: this._element
                        }),
                        a = p.Event(ft.SHOW, {
                            relatedTarget: i
                ...
                p.removeData(this._element, ct), this._element = null
            }, e._activate = function(e, t, n) {
                var i = this,
                    o = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? p(t).children(pt) : p(t).find(mt))[0],
                ...
                if (p(e).addClass(ht), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), m.reflow(e), p(e).addClass("show"), e.parentNode && p(e.parentNode).hasClass("dropdown-menu")) {
    ...
    p(document).on(ft.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(e) {
        e.preventDefault(), gt._jQueryInterface.call(p(this), "show")
    }), p.fn.tab = gt._jQueryInterface, p.fn.tab.Constructor = gt, p.fn.tab.noConflict = function() {
        return p.fn.tab = ut, gt._jQueryInterface
    };
    var vt = "toast",
        bt = "bs.toast",
        yt = "." + bt,
        ...
        Et = function() {
            ...
            return e.show = function() {
                var e = this;
                p(this._element).trigger(wt.SHOW), this._config.animation && this._element.classList.add("fade");
                var t = function() {
                    e._element.classList.remove(Ct), e._element.classList.add(kt), p(e._element).trigger(wt.SHOWN), e._config.autohide && e.hide()
                };
                ...
                var t = this;
                this._element.classList.contains(kt) && (p(this._element).trigger(wt.HIDE), e ? this._close() : this._timeout = setTimeout(function() {
                    t._close()
                }, this._config.delay))
            }, e.dispose = function() {
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(kt) && this._element.classList.remove(kt), p(this._element).off(wt.CLICK_DISMISS), p.removeData(this._element, bt), this._element = null, this._config = null
            }, e._getConfig = function(e) {
                return e = l({}, Tt, p(this._element).data(), "object" == typeof e && e ? e : {}), m.typeCheckConfig(vt, e, this.constructor.DefaultType), e
            }, e._setListeners = function() {
                var e = this;
                p(this._element).on(wt.CLICK_DISMISS, '[data-dismiss="toast"]', function() {
                    return e.hide(!0)
                })
            }, e._close = function() {
                var e = this,
                    t = function() {
                        e._element.classList.add("hide"), p(e._element).trigger(wt.HIDDEN)
                    };
                ...
                return this.each(function() {
                    var e = p(this),
                        t = e.data(bt);
                    if (t || (t = new i(this, "object" == typeof n && n), e.data(bt, t)), "string" == typeof n) {
                        if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                        t[n](this)
                    }
                })
    ...
    p.fn[vt] = Et._jQueryInterface, p.fn[vt].Constructor = Et, p.fn[vt].noConflict = function() {
            return p.fn[vt] = _t, Et._jQueryInterface
        },
        function() {
            if (void 0 === p) throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");
            var e = p.fn.jquery.split(" ")[0].split(".");
            if (e[0] < 2 && e[1] < 9 || 1 === e[0] && 9 === e[1] && e[2] < 1 || 4 <= e[0]) throw new Error("Bootstrap's JavaScript requires at least jQuery v1.9.1 but less than v4.0.0")
        }(), e.Util = m, e.Alert = d, e.Button = k, e.Carousel = L, e.Collapse = V, e.Dropdown = de, e.Modal = Ce, e.Popover = Ve, e.Scrollspy = lt, e.Tab = gt, e.Toast = Et, e.Tooltip = Be, Object.defineProperty(e, "__esModule", {
            value: !0
        })
}),
function() {
...
function() {
    ...
    function(o) {
        o.fn.UItoTop = function(e) {
            ...
            }).prepend('<span id="' + t.containerHoverID + '"></span>').on("mouseover", function () {
        ...
        var n = function(i, d) {
            ...
            if (d.getElementsByClassName) {
                ...
                var S = (ne = /^img$/i, ie = /^iframe$/i, oe = "onscroll" in i && !/glebot/.test(navigator.userAgent), ae = -1, le = function(e) {
                        ...
                        for (z -= t, Q += t, F -= t, U += t; o && (i = i.offsetParent) && i != d.body && i != h;)(o = 0 < (x(i, "opacity") || 1)) && "visible" != x(i, "overflow") && (n = i.getBoundingClientRect(), o = U > n.left && F < n.right && Q > n.top - 1 && z < n.bottom + 1);
                        return o
                    }, V = de = function() {
                        var e, t, n, i, o, r, s, a, l, c = u.elements;
                        if ((W = f.loadMode) && se < 8 && (e = c.length)) {
                            t = 0, ae++, null == Y && ("expand" in f || (f.expand = 500 < h.clientHeight && 500 < h.clientWidth ? 500 : 370), K = f.expand, Y = K * f.expFactor), re < Y && se < 1 && 2 < ae && 2 < W && !d.hidden ? (re = Y, ae = 0) : re = 1 < W && 1 < ae && se < 6 ? K : 0;
                            for (; t < e; t++)
                                if (c[t] && !c[t]._lazyRace)
                                    if (oe)
                                        if ((a = c[t][p]("data-expand")) && (r = 1 * a) || (r = re), l !== r && (M = innerWidth + r * $, R = innerHeight + r, s = -1 * r, l = r), n = c[t].getBoundingClientRect(), (Q = n.bottom) >= s && (z = n.top) <= R && (U = n.right) >= s * $ && (F = n.left) <= M && (Q || U || F || z) && (f.loadHidden || "hidden" != x(c[t], "visibility")) && (L && se < 3 && !a && (W < 3 || ae < 4) || ce(c[t], r))) {
                                            if (ve(c[t]), o = !0, 9 < se) break
                                        } else !o && L && !i && se < 4 && ae < 4 && 2 < W && (P[0] || f.preloadAfterLoad) && (P[0] || !a && (Q || U || F || z || "auto" != c[t][p](f.sizesAttr))) && (i = P[0] || c[t]);
                            else ve(c[t]);
                            i && !o && ve(i)
                        }
                        ...
                        (c = k(e, "lazybeforeunveil", t)).defaultPrevented || (i && (n ? y(e, f.autosizesClass) : e.setAttribute("sizes", i)), s = e[p](f.srcsetAttr), r = e[p](f.srcAttr), o && (a = e.parentNode, l = a && g.test(a.nodeName || "")), d = t.firesLoad || "src" in e && (s || r || l), c = {
                            ...
                            src: r
                        })), e._lazyRace && delete e._lazyRace, _(e, f.lazyClass), E(function() {
                        ...
                        if (!L) {
                            ...
                            L = !0, f.loadMode = 3, ue(), t("scroll", function() {
                                3 == f.loadMode && (f.loadMode = 2), e()
                            }, !0)
                        }
                    }, {
                        _: function() {
                            B = r.now(), u.elements = d.getElementsByClassName(f.lazyClass), P = d.getElementsByClassName(f.lazyClass + " " + f.preloadClass), $ = f.hFac, t("scroll", ue, !0), t("resize", ue, !0), i.MutationObserver ? new MutationObserver(ue).observe(h, {
                                childList: !0,
                                subtree: !0,
                                attributes: !0
                                ...
                                d[s](e, ue, !0)
                            }), /d$|^c/.test(d.readyState) ? be() : (t("load", be), d[s]("DOMContentLoaded", ue), m(be, 2e4)), u.elements.length ? (de(), E._lsFlush()) : ue()
                        },
                        checkElems: ue,
                        unveil: ve = function(e) {
                            var t, n = ne.test(e.nodeName),
                                ...
                                o = "auto" == i;
                            (!o && L || !n || !e[p]("src") && !e.srcset || e.complete || b(e, f.errorClass) || !b(e, f.lazyClass)) && (t = k(e, "lazyunveilread").detail, o && A.updateElem(e, !0, e.offsetWidth), e._lazyRace = !0, se++, ge(e, t, o, i, n))
                        }
                    }),
            ...
            var N, I, O, q;
            var P, L, H, W, B, M, R, z, F, U, Q, K, Y, $, V, X, G, J, Z, ee, te, ne, ie, oe, re, se, ae, le, ce, de, ue, fe, he, pe, me, ge, ve, be;
    ...
    function(e) {
        ...
        function o(e, t) {
            this.element = e, this.options = L.extend({}, i, t);
            var n = this.options.locale;
            void 0 !== this.options.locales[n] && L.extend(this.options, this.options.locales[n]), this.init()
        }
        ...
        function H(e) {
            if (!L(e.target).parents().hasClass("jq-selectbox") && "OPTION" != e.target.nodeName && L("div.jq-selectbox.opened").length) {
                var t = L("div.jq-selectbox.opened"),
                    n = L("div.jq-selectbox__search input", t),
                    i = L("div.jq-selectbox__dropdown", t);
        ...
        o.prototype = {
            init: function() {
                ...
                if (O.is(":checkbox")) {
                    ...
                    var n = function() {
                        var e = new I,
                            n = L('<div class="jq-radio"><div class="jq-radio__div"></div></div>').attr({
                                id: e.id,
                                title: e.title
                            }).addClass(e.classes).data(e.data);
                        O.after(n).prependTo(n), O.is(":checked") && n.addClass("checked"), O.is(":disabled") && n.addClass("disabled"), L.fn.commonParents = function() {
                            var e = this;
                    ...
                    var i = function() {
                        ...
                        var o = L('<div class="jq-file"><div class="jq-file__name">' + i + '</div><div class="jq-file__browse">' + t + "</div></div>").attr({
                            id: e.id,
                            title: e.title
                        }).addClass(e.classes).data(e.data);
                        O.after(o).appendTo(o), O.is(":disabled") && o.addClass("disabled");
                        var n = O.val(),
                            r = L("div.jq-file__name", o);
                    ...
                    var o = function() {
                        ...
                        var r, s, a, n = null,
                            i = null;
                        void 0 !== O.attr("min") && (r = O.attr("min")), void 0 !== O.attr("max") && (s = O.attr("max")), a = void 0 !== O.attr("step") && L.isNumeric(O.attr("step")) ? Number(O.attr("step")) : Number(1);
                        var o = function(e) {
                            var t, n = O.val();
                            L.isNumeric(n) || (n = 0, O.val("0")), e.is(".minus") ? t = Number(n) - a : e.is(".plus") && (t = Number(n) + a);
                            var i = (a.toString().split(".")[1] || []).length;
                            if (0 < i) {
                                for (var o = "1"; o.length <= i;) o += "0";
                                t = Math.round(t * o) / o
                            }
                            L.isNumeric(r) && L.isNumeric(s) ? r <= t && t <= s && O.val(t) : L.isNumeric(r) && !L.isNumeric(s) ? r <= t && O.val(t) : !L.isNumeric(r) && L.isNumeric(s) ? t <= s && O.val(t) : O.val(t)
                        };
                        ...
                        if (O.is("[multiple]")) {
                            ...
                            ! function() {
                                ...
                                void 0 !== i && 0 < i ? n.css({
                                    ...
                                    L(this).is(":selected") && o.eq(L(this).index()).addClass("selected")
                            ...
                            var a = L("div.jq-selectbox__select", c),
                                u = L("div.jq-selectbox__select-text", c),
                                f = D.filter(":selected");
                            ...
                            var h = L('<div class="jq-selectbox__dropdown">' + t + "<ul>" + N + "</ul></div>");
                            c.append(h);
                            var p = L("ul", h),
                                m = L("li", h),
                                g = L("input", h),
                                v = L("div.jq-selectbox__not-found", h).hide();
                            ...
                            if (T.length < 1 && m.first().addClass("selected sel"), void 0 === m.data("li-height")) {
                                var E = m.outerHeight();
                                !1 !== n && (E = m.eq(1).outerHeight()), m.data("li-height", E)
                            }
                            var j = h.css("top");
                            if ("auto" == h.css("left") && h.css({
                                    ...
                                    top: k
                                }), j = k), h.hide(), T.length && (D.first().text() != f.text() && c.addClass("changed"), c.data("jqfs-class", T.data("jqfs-class")), c.addClass(T.data("jqfs-class"))), O.is(":disabled")) return c.addClass("disabled");
                            a.on('click', function() {
                                if (L("div.jq-selectbox").filter(".opened").length && q.onSelectClosed.call(L("div.jq-selectbox").filter(".opened")), O.focus(), !P) {
                                    var t = L(window),
                                        n = m.data("li-height"),
                                        i = c.offset().top,
                                    ...
                                    !0 === l || 1 === l ? r + C + 20 < o ? (a(), c.removeClass("dropup").addClass("dropdown")) : (function() {
                                        ...
                                        zIndex: d
                                    }), h.is(":hidden") ? (L("div.jq-selectbox__dropdown:visible").hide(), h.show(), c.addClass("opened focused"), q.onSelectOpened.call(c)) : (h.hide(), c.removeClass("opened dropup dropdown"), L("div.jq-selectbox").filter(".opened").length && q.onSelectClosed.call(c)), g.length && (g.val("").keyup(), v.hide(), g.keyup(function() {
                                        var e = L(this).val();
                                        m.each(function() {
                            ...
                            m.filter(":not(.disabled):not(.optgroup)").on('click', function() {
                                O.focus();
                                var e = L(this),
                                    t = e.text();
                                if (!e.is(".selected")) {
                            ...
                            }), H.registered || (L(document).on("click", H), H.registered = !0)
                        }()
                    };
            ...
            return void 0 === t || "object" == typeof t ? (this.each(function() {
                L.data(this, "_" + r) || L.data(this, "_" + r, new o(this, t))
            }).promise().done(function() {
                var e = L(this[0]).data("_" + r);
                e && e.options.onFormStyled.call()
            }), this) : "string" == typeof t && "_" !== t[0] && "init" !== t ? (this.each(function() {
                var e = L.data(this, "_" + r);
...
Berserk.settings.gmap_api_key = "undefined" != typeof brk && void 0 !== brk.gmap_api_key ? brk.gmap_api_key : "AIzaSyDEE4w3qmvL1fF91KiHhySPYZNiULI0YRo", Berserk.settings.recaptcha_api_key = "undefined" != typeof brk && void 0 !== brk.recaptcha_api_key ? brk.recaptcha_api_key : "6Lfsu3QUAAAAAO6j2iAsncliNSQqISfipl0DjPAp", Berserk.settings.project_prefix = "undefined" != typeof brk && void 0 !== brk.shorcodesurl ? brk.shorcodesurl : "", jQuery.noConflict(), window.lazySizesConfig = window.lazySizesConfig || {}, window.lazySizesConfig.expand = 500,
    ...
    function(a) {
        isSafari() && a("html").addClass(""), jQuery.cachedScript = function(e, t) {
            return t = a.extend(t || {}, {
                crossDomain: !0,
                dataType: "script",
                cache: !0,
            ...
            Berserk.attachBehaviors(a("body"), Berserk.settings),
                function() {
                    if (a("[data-brk-library]:not(.brk-library-rendered)").addClass("brk-library-rendered").each(function() {
                            ...
                            for (o in e) void 0 === s[e[o]] && (s[e[o]] = 1, d(e[o]))
                        }), Object.keys(r.css).length) {
                        var e = "",
                            t = "",
                            n = "";
                        for (o in brk_xmode && (t = 'class="" '), r.css) n = Berserk.settings.project_prefix && -1 === r.css[o].indexOf("//") ? Berserk.settings.project_prefix : "", console.log("CSS added: " + n + r.css[o]), e += "<link " + t + 'rel="stylesheet"  href="' + n + r.css[o] + '">';
                        a("head").append(e)
                    }
                    if (Object.keys(r.js).length) {
                        var i = 0;
                        for (o in r.js) n = Berserk.settings.project_prefix && -1 === r.js[o].indexOf("//") ? Berserk.settings.project_prefix : "", console.log("JS added: " + n + r.js[o]), a.cachedScript(n + r.js[o]).done(function(e, t) {
                            i += 1, Object.keys(r.js).length === i && (Berserk.attachBehaviors(a("body"), Berserk.settings), r = {
                                css: {},
                                js: {}
                            })
                        })
        ...
        e.length && e.each(function() {
            ...
            attach: function(e, t) {}
        }, Berserk.behaviors.counter_lib_init = {}, a(document).on('ready', function() {
            ...
            attach: function(e, t) {
                if (!(a(".fancybox:not(.rendered), .fancybox-media:not(.rendered)").length < 1)) {
                    if (void 0 === a.fn.fancybox) return console.log("Waiting for the fancybox library"), void setTimeout(Berserk.behaviors.fancybox_init.attach, 200, e, t);
        ...
        function d(e) {
            if (void 0 !== n[e]) {
                if (void 0 !== n[e].dependency)
                    for (o in n[e].dependency) void 0 === s[n[e].dependency[o]] && (s[n[e].dependency[o]] = 1, d(n[e].dependency[o]));
                if (void 0 !== n[e].css)
                    for (o in n[e].css) t[n[e].css[o]] || (t[n[e].css[o]] = !0, r.css[n[e].css[o]] = n[e].css[o]);
                if (void 0 !== n[e].js)
                    for (o in n[e].js) t[n[e].js[o]] || (t[n[e].js[o]] = !0, r.js[n[e].js[o]] = n[e].js[o])
            }
        }
        a(document).on('ready', function() {
            ...
            t && function(e) {
                ...
                for (var i in t)
                    if (l[t[i]]) {
                        if (void 0 !== l[t[i]].js)
                            for (var o in l[t[i]].js) c[l[t[i]].js[o]] || (c[l[t[i]].js[o]] = !0, n = Berserk.settings.project_prefix && -1 === l[t[i]].js[o].indexOf("//") ? Berserk.settings.project_prefix : "", console.log("JS added: " + n + l[t[i]].js[o]), a.cachedScript(n + l[t[i]].js[o]).done(function(e, t) {
                                Berserk.attachBehaviors(a("body"), Berserk.settings)
                            }));
                        if (void 0 !== l[t[i]].css)
                            for (o in l[t[i]].css) c[l[t[i]].css[o]] || (c[l[t[i]].css[o]] = !0, n = Berserk.settings.project_prefix && -1 === l[t[i]].css[o].indexOf("//") ? Berserk.settings.project_prefix : "", console.log("CSS added: " + n + l[t[i]].css[o]), a("head").append('<link rel="stylesheet"  href="' + n + l[t[i]].css[o] + '">'))
                    }
            }(t)
        });
        var n = {
            ...
            slider__swiper: {
                ...
                css: ["assets/vendor/swiper/css/swiper.min.css"],
                js: ["assets/vendor/swiper/js/swiper.min.js", "assets/js/assets/swiper-skin.js"]
            },
            slider__slick: {},
            slider__rotator: {},
            jquerySlider: {},
            ...
            component__sliders_css: {
                css: ["assets/css/components/sliders.css"]
            },
            component__content_slider: {
                css: ["css/components/content-sliders.css"]
            },
            component__team: {
                css: ["assets/css/components/team.css"],
                js: ["assets/js/components/team.js"]
            },
            ...
            component__countdown: {
                css: ["assets/css/components/countdown.css"],
                js: ["assets/js/components/jquery.countdown.min.js", "assets/js/components/underscore-min.js", "assets/js/components/countdown.js"]
            },
        ...
        window.xMode ? (a("html").removeClass("brk-preloader"), a(".brk-header:not(.brk-header_vertical)").css("display", "").addClass("d-flex")) : (window.addEventListener("load", function() {
            a("html").addClass("brk-preloader-remove"), setTimeout(function() {
                a("html").removeClass("brk-preloader brk-preloader-remove"), a(".brk-header:not(.brk-header_vertical)").css("display", "").addClass("d-flex")
            }, 1500)
        }), setTimeout(function() {
            a("html").addClass("brk-preloader-remove"), setTimeout(function() {
                a("html").removeClass("brk-preloader brk-preloader-remove"), a(".brk-header:not(.brk-header_vertical)").css("display", "").addClass("d-flex")
            }, 1500)
        }, 5e3)), brk_xmode && window.addEventListener("load", function() {
            var e = a(".brk-css-add"),
    ...
    function(C) {
        ...
        Berserk.behaviors.header_init = {
            attach: function(e, t) {
                C(e).parent().find(".brk-header:not(.rendered)").addClass("rendered").each(function() {
                                ...
                                if (1 !== r)
                                    if (e <= (window.innerWidth || C(window).width())) {
                                        if (a.length) {
                                            ...
                                            if (0 < C(window).scrollTop())
                                                if (C(".brk-open-top-bar").length && d.find(".brk-open-top-bar").removeClass("active"), C("body").hasClass("admin-bar")) {
                                                    var n = t - 32;
                                                    d.css("top", "-" + n + "px")
                                                } else d.css("top", "-" + t + "px");
                                            else C(window).scrollTop() <= 0 && (C(".brk-open-top-bar").length && d.find(".brk-open-top-bar").addClass("active"), C("body").hasClass("admin-bar") ? d.css("top", "32px") : d.css("top", "0"))
                                        }
                                    } else d.css("top", "0")
                            };
                        setTimeout(function() {
                            e(992)
                        }, 2e3), t(992), C(window).on("resize scroll", function() {
                            e(992), t(992)
                        })
                    }
                    if (C(".brk-open-top-bar").length) {
                    ...
                    function c(e) {
                        ...
                        d.hasClass("brk-header_not-fixed") || e <= t && (0 < C(window).scrollTop() ? (d.addClass("brk-header_scroll"), o && i.css("height", o + "px")) : C(window).scrollTop() <= 0 && (d.removeClass("brk-header_scroll"), o && i.css("height", n + "px"))), 0 < C(window).scrollTop() ? C(".brk-header-mobile").addClass("brk-header-mobile_scroll") : C(window).scrollTop() <= 0 && C(".brk-header-mobile").removeClass("brk-header-mobile_scroll")
                    }
                    if (o && i.data("height-temp", i.height()), c(992), C(window).on("scroll", function() {
                            c(992)
                        }), 1 === r) {
                        var u = 0;
                        setTimeout(function() {
                    ...
                    function h(e) {
                        ...
                        if (t < e && !f) {
                            ...
                            var n = C(".brk-header-mobile-wrap"),
                                i = C(".brk-header-mobile-wrap__body"),
                                o = d.data("logo-src"),
                                r = d.data("bg-mobile");
                            i.prepend('<div class="brk-before"></div><div class="brk-header-mobile-wrap__header"><div class="brk-header-mobile-wrap__close"><span></span></div></div>'), "" !== o && C(".brk-header-mobile-wrap__header").prepend('<div class="brk-header-mobile-wrap__logo"><img src="' + o + '" alt=""></div>'), "" !== r && void 0 !== r && n.css("background-image", "url(" + r + ")"), n.before('<div class="brk-header-mobile-wrap-layer"></div>'), f = !0
                        } else e <= t && f && (C(".brk-header-mobile-wrap__header").detach(), C(".brk-header-mobile-wrap-layer").remove(), C(".brk-before, .brk-header-mobile-wrap__header").remove(), d.unwrap(), d.unwrap(), f = !1);
                        var s = C(".brk-header-mobile"),
                            a = s.find(".brk-header-mobile__open"),
                            l = (n = C(".brk-header-mobile-wrap")).find(".brk-header-mobile-wrap__close"),
                            c = C(".brk-header-mobile-wrap-layer");
                        s.length && a.on("click", function() {
                            C("body").addClass("modal-open"), n.addClass("is-active"), c.addClass("is-active")
                        }), n.length && l.on("click", function() {
                            C("body").removeClass("modal-open"), n.removeClass("is-active"), c.removeClass("is-active")
                        })
                    }
                    h(992), C(window).on("resize", function() {
                        h(992)
                    });
                    var p = !1;

                    function m(e) {
                        var t = C(".brk-nav, .brk-header-popup-menu"),
                            n = t.find(".brk-nav__children"),
                            i = t.find(".brk-nav__menu > li").children("a"),
                            o = t.find("a"),
                            r = window.innerWidth || C(window).width();
                        if (r < e && !p) {
                            if (n.prepend('<div class="brk-nav__link-open"><i class="fa fa-angle-right"></i></div>'), C(".brk-nav__link-open").length) {
                                var s = C(".brk-nav__link-open");
                            ...
                            o.each(function() {
                                ...
                                "#" === n[0] && e.on("click", function(e) {
                                    if (e.preventDefault(), C(n).length) {
                                        var t = C(this).parents(".brk-header-mobile-wrap");
                                        C("body").removeClass("modal-open"), t.removeClass("is-active"), C(".brk-header-mobile-wrap-layer").removeClass("is-active")
                                    }
                                })
                            }), p = !0
                        } else 0 < C(".brk-nav__link-open").length && e <= r && p && (C(".brk-nav__link-open").remove(), n.removeClass("children-active"), p = !1)
                    }
                    C(window).on("load", function() {
                        m(992)
                    }), C(window).on("resize", function() {
                        m(992)
                    }), C(".brk-nav__drop-down-effect").each(function() {
                        var e = C(this),
                            o = e.find(".dd-effect");
                        e.on("mouseenter", function() {
                            var e, t, n, i;
                            e = o, t = 10, i = "left" === n ? {
                                ...
                                opacity: 0,
                                left: -10
                            }, (e = "left" === n ? C(e.get().reverse()) : e).css(i).each(function(e) {
                                C(this).delay(t * e).animate({
                                    opacity: 1,
                                    left: 0
                                })
                            })
                        })
                    }), C(".brk-quantity").find(".brk-quantity__arrows").on("click", function() {
                        var e = C(this).parent().find(".brk-quantity__value"),
                            t = e.val();
                        C(this).hasClass("minus") && 1 < t ? e.val(+t - 1) : C(this).hasClass("plus") && e.val(+t + 1)
                    });
                    var g = C(".brk-info-menu"),
                        v = C(".brk-info-menu-open"),
                        b = g.find(".brk-info-menu__close"),
                        y = window.innerWidth || C(window).width();

                    function _(e, t, n, i) {
                        t = (e = C(e)).find(t), n = e.find(n);
                        var o = window.innerWidth || C(window).width();
                    ...
                    function w(e) {
                        var t = window.innerWidth || C(window).width();
                        t < e ? C(".brk-lang:not(.brk-lang-rendered)").addClass("brk-lang-rendered").each(function() {
                            var e = C(this),
                        ...
                        }).removeClass("brk-lang_interactive-rendered") : e <= t && (C(".brk-lang_interactive:not(.brk-lang_interactive-rendered)").addClass("brk-lang_interactive-rendered").each(function() {
                            var e = C(this),
                            ...
                            t.css({
                                ...
                                mouseenter: function() {
                                    i.css("opacity", "0"), n.css("background", "transparent !important"), t.addClass("top-bar-bg"), C("div").is(".brk-overlay") || d.after('<div class="brk-overlay"></div>'), o.css("border", "0")
                                },
                                mouseleave: function() {
                                    i.css("opacity", "1"), n.removeAttr("style"), t.removeClass("top-bar-bg"), C("div").is(".brk-overlay") && C(".brk-overlay").remove(), o.css("border", "")
                                }
                            })
                        }).removeClass("brk-lang-rendered"), C(".brk-lang__option").css("display", ""), C(".brk-lang").find(".brk-lang__open").unbind("click"))
                    }

                    function k() {
                        var n = window.innerWidth || C(window).width();
                        if (!(n < 992)) {
                            C(".brk-mini-cart, .brk-social-links, .brk-search, .brk-lang, .brk-nav__sub-menu, .flexMenu-popup").each(function() {
                                var e = C(this),
                                    t = n / 2 + 350;
                    ...
                    v.on("click", function() {
                            g.toggleClass("active"), v.toggleClass("open-active"), 992 <= y && C("body").toggleClass("modal-open")
                        }), b.on("click", function() {
                            g.hasClass("active") && g.removeClass("active"), v.hasClass("open-active") && v.removeClass("open-active"), 992 <= y && C("body").hasClass("modal-open") && C("body").removeClass("modal-open")
                        }), C(document).on("click", function(e) {
                            C(e.target).closest(".brk-info-menu").length || C(e.target).closest(".brk-info-menu-open").length || (g.hasClass("active") && g.removeClass("active"), v.hasClass("open-active") && v.removeClass("open-active"), 992 <= y && C("body").hasClass("modal-open") && C("body").removeClass("modal-open")), e.stopPropagation()
                        }), _(".brk-mini-cart", ".brk-mini-cart__open, .brk-mini-cart__info-open", ".brk-mini-cart__menu", 992), _(".brk-social-links", ".brk-social-links__open", ".brk-social-links__block", 992), _(".brk-search", ".brk-search__open", ".brk-search__block", 992), C(window).on("resize", function() {
                            _(".brk-mini-cart", ".brk-mini-cart__open, .brk-mini-cart__info-open", ".brk-mini-cart__menu", 992), _(".brk-social-links", ".brk-social-links__open", ".brk-social-links__block", 992), _(".brk-search", ".brk-search__open", ".brk-search__block", 992)
                        }), 992 <= (window.innerWidth || C(window).width()) && C(".brk-search_interactive").each(function() {
                            var e = C(this),
                            ...
                            i.on("click", function() {
                                r.addClass("active"), n.addClass("position-relative"), a.hide(0), C(this).hide(0), C("div").is(".brk-overlay") || d.after('<div class="brk-overlay"></div>'), setTimeout(function() {
                                    s.focus()
                                }, 150), l.css("border", "0")
                            }), o.on("click", function() {
                                r.removeClass("active"), a.show(0), i.show(0), n.removeClass("position-relative"), C("div").is(".brk-overlay") && C(".brk-overlay").remove(), l.css("border", "")
                            }), C(document).on("click", function(e) {
                                C(e.target).closest(".brk-header").length || (r.removeClass("active"), a.show(0), i.show(0), n.removeClass("position-relative"), C("div").is(".brk-overlay") && C(".brk-overlay").remove(), l.css("border", "")), e.stopPropagation()
                            })
                        }), window.addEventListener("load", function() {
                            w(992)
                        }), C(window).on("resize", function() {
                        ...
                        function() {
                            if (0 < C(".brk-header-popup-menu").length) {
                                d.after('<div class="brk-header-popup-menu-layer"></div>');
                                var t = C(".brk-header-popup-menu").find(".brk-header-popup-menu__open-close"),
                                    n = C(".brk-header-popup-menu__menu"),
                                    i = C(".brk-header-popup-menu-layer"),
                                    o = n.find("a");
                                0 < C(".brk-header_vertical").length && (C(".brk-header").append(n), n.addClass("brk-moved-by-js")), t.on("click", function() {
                                    C(this).toggleClass("is-active"), n.fadeToggle(300), i.fadeToggle(500)
                                }), i.on("click", function() {
                                    var e = C(this);
                                    t.toggleClass("is-active"), n.fadeToggle(300), e.fadeToggle(500)
                                }), o.each(function() {
                                    var e = C(this).attr("href");
                                    "#" === e[0] && 1 < e.length && C(e).length && o.on("click", function() {
                                        t.removeClass("is-active"), n.fadeOut(300), i.fadeOut(500)
                                    })
                                })
                            }
                        }(), C(".brk-totop").on("click", function() {
                            C("html, body").stop().animate({
                                scrollTop: 0
                            }, 500)
                        }), k(), C(window).on("load resize", function() {
                            setTimeout(function() {
                                k()
                            }, 300)
                        })
            ...
            attach: function(e, t) {
                if (!(C(".brk-nav:not(.rendered)").length < 1)) {
                    if ("function" != typeof C.fn.flexMenu) return console.log("Waiting for the flexMenu library"), void setTimeout(Berserk.behaviors.header_init_menu_flex.attach, t.timeout_delay, e, t);
                    var r = !0;
                    C(e).parent().find(".brk-nav:not(.rendered)").addClass("rendered").each(function() {
                        var e = C(this),
                            i = e.find(".brk-nav__menu"),
                            o = e.data("flexmenu-link-text");
                        0 === e.closest(".brk-header_vertical").length && (o = o || "More", C(window).on("load resize", function() {
                            var t, e, n;
                            t = i, e = o, (n = window.innerWidth || C(window).width()) < 992 && !r ? (t.flexMenu({
                                undo: !0
                            }), r = !0) : 992 <= n && r && (t.flexMenu({
                                linkText: e
                            }), setTimeout(function() {
                                if (C(".flexMenu-viewMore").length) {
                                    var e = C(".flexMenu-popup").offset().left + 80;
            ...
            attach: function(e, t) {
                ...
                m(".brk-tabs:not(.rendered)", e).addClass("rendered").each(function() {
                    if (m(this).hasClass("brk-tabs-hovers")) {
                        var e = (d = m(this)).find(".brk-tabs-nav"),
                            n = (a = d.find(".brk-tab"), l = d.find(".brk-tab-item"), c = d.data("index"), d.closest(".brk-header_style-1")),
                            t = d.closest(".brk-header_style-2"),
                            i = d.closest(".brk-header_style-3");
                        if (c = c || 0, n[0] ? d.addClass("brk-tabs-hovers_style-1") : t[0] ? d.addClass("brk-tabs-hovers_style-2") : i[0] && d.addClass("brk-tabs-hovers_style-3"), n[0] && e.append('<div class="brk-tabs-hovers__duplicate-icon"></div>'), m(window).on("load", function() {
                                l.hide().eq(c).fadeIn(), a.eq(c).addClass("current")
                            }), n[0]) {
                            var o = d.find(".current").children('[class*="fa-"]'),
                                r = e.find(".brk-tabs-hovers__duplicate-icon");
                            o.clone().appendTo(r)
                        }
                        var s = function(e) {
                            var t = window.innerWidth || m(window).width();
                            t < e ? a.on("click", function() {
                                var e = m(this),
                                    t = e.children('[class*="fa-"]');
                                n[0] && (r.empty(), t.clone().appendTo(r)), e.hasClass("current") || (a.removeClass("current").eq(m(this).index()).addClass("current"), l.hide().eq(m(this).index()).fadeIn())
                            }).unbind("mouseenter") : e <= t && a.on("mouseenter", function() {
                                var e = m(this),
                                    t = e.children('[class*="fa-"]');
                                n[0] && (r.empty(), t.clone().appendTo(r)), e.hasClass("current") || (a.removeClass("current").eq(m(this).index()).addClass("current"), l.hide().eq(m(this).index()).fadeIn())
                            }).unbind("click")
                        };
                        s(992), m(window).on("resize", function() {
                            s(992)
                        })
                    } else {
                        var a = (d = m(this)).find(".brk-tab"),
                            l = d.find(".brk-tab-item"),
                            c = d.data("index");
                        d.data("hash"), window.location.hash;
                        c = c || 0, m(window).on("load", function() {
                            l.hide().eq(c).fadeIn()
                        }), a.on("click", function() {
                            m(this).addClass("active").siblings(".active").removeClass("active no-hover"), l.hide().eq(m(this).index()).fadeIn();
                            var e = l.eq(m(this).index()).find(".slick-slider");
                            e.length && e.each(function() {
                                var e, t = m(this);
                    ...
                    if (m(this).hasClass("brk-tabs-simple-top") || m(this).hasClass("brk-tabs-simple-bottom") || m(this).hasClass("brk-tabs-bottom-top") || m(this).hasClass("brk-tabs-bottom-bottom") || m(this).hasClass("brk-tabs-parallax") || m(this).hasClass("brk-tabs_tabbed-filter")) {
                        var d, u = (d = m(this)).find(".brk-tabs-nav"),
                            f = (a = d.find(".brk-tab"), d.find(".brk-tab.active"));
                        u.append("<span class='magic-line'></span>");
                        var h = d.find(".magic-line");
                        window.addEventListener("load", function() {
                            setTimeout(function() {
                                p(h, f)
                            }, 500)
                            ...
                            mouseleave: function() {
                                ...
                                }), d.find(".brk-tab.active").removeClass("no-hover")
                            }
                        })
                    }
                })
        ...
        Berserk.behaviors.buttons_js = {
            attach: function(e, t) {
                r(window).on("load", function() {
                    ...
                    }), r(e).parent().find(".btn-inside-out:not(.rendered)").addClass("rendered").each(function() {
            ...
            attach: function(e, t) {
                if (r(".brk-footer__wrapper:not(.rendered)", e).each(function() {
                        if (r(this).hasClass("brk-footer__wrapper_animated")) {
                            ...
                            i >= e.outerHeight(!0) && o(), r(this).on("DOMSubtreeModified", function() {
    ...
    function(n) {
        ...
        Berserk.behaviors.sliders_page_init = {
            attach: function(e, t) {
                if (!(n(".brk-carousel_project:not(.rendered)").length < 1)) return void 0 === n.fn.slick ? (console.log("Waiting for the slick library"), void setTimeout(Berserk.behaviors.sliders_page_init.attach, t.timeout_delay, e, t)) : void n(e).parent().find(".brk-carousel_project:not(.rendered)").addClass("rendered").each(function() {
                    var e = n(this),
